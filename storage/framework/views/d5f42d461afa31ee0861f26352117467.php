...
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($data)]); ?>
     <?php $__env->slot('title', null, []); ?> Prestasi & Sertifikasi <?php $__env->endSlot(); ?>
    ...
    <section class="pt-12 border-t border-slate-100 text-center">
        <div class="max-w-md mx-auto space-y-4">
            ...
            <div class="flex justify-center gap-3 pt-2">
                <a href="mailto:<?php echo e($data['profile']['email']); ?>" class="btn-primary text-xs px-5 py-2.5">Minta Berkas Kredensial</a>
                <a href="<?php echo e(route('home')); ?>" class="btn-outline text-xs px-5 py-2.5">Kembali ke Beranda</a>
            </div>
        </div>
    </section>
...
<?php endif; ?><?php /**PATH C:\laragon\www\webporto2\resources\views/achievements.blade.php ENDPATH**/ ?>