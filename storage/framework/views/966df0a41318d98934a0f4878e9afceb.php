    ...
    <header class="fixed top-0 left-0 w-full z-50 transition-all duration-500" id="main-header">
        <div class="max-w-6xl mx-auto px-4 py-3 md:py-4">
            <nav class="glass rounded-full px-3 py-2 md:px-4 flex justify-between items-center shadow-lg shadow-slate-200/30" aria-label="Navigasi Utama">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2.5 group" aria-label="Beranda">
                    <div class="w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white shadow-md shadow-primary/20 group-hover:rotate-6 transition-transform">
                        <img src="<?php echo e(asset('logo.svg')); ?>" alt="Logo" class="w-4 h-4 object-contain">
                    </div>
                ...
                <div class="hidden md:flex items-center gap-0.5 rounded-full border border-slate-200/70 bg-slate-100/80 p-0.5">
                    <?php $__currentLoopData = $navigationItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route($item['route'])); ?>" class="nav-link <?php echo e(request()->routeIs($item['active']) ? 'active' : ''); ?>">
                            <i data-lucide="<?php echo e($item['icon']); ?>" class="w-3 h-3"></i>
                ...
                <div class="hidden md:block">
                    <a href="mailto:<?php echo e($data['profile']['email']); ?>" class="btn-primary btn-primary-sm" aria-label="Hubungi Saya">
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-3 rounded-2xl border border-slate-200/70 bg-white/95 p-2 shadow-xl shadow-slate-200/60 backdrop-blur-xl" aria-label="Menu Navigasi Mobile">
                <div class="grid gap-1">
                    <?php $__currentLoopData = $navigationItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route($item['route'])); ?>" class="mobile-nav-link <?php echo e(request()->routeIs($item['active']) ? 'active' : ''); ?>">
                ...
                <a href="mailto:<?php echo e($data['profile']['email']); ?>" class="mt-2 flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-black text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary-dark">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14 mb-14 md:mb-20">
                <div class="md:col-span-1">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 mb-8">
                        <div class="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center text-white shadow-lg shadow-primary/20">
                            <img src="<?php echo e(asset('logo.svg')); ?>" alt="Logo" class="w-6 h-6 object-contain">
                        </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <?php $__currentLoopData = $footerNavigationItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route($item['route'])); ?>" class="footer-link">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <?php $__currentLoopData = $contactItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e($item['href']); ?>" class="footer-link break-all" <?php if($item['external']): ?> target="_blank" rel="noopener noreferrer" <?php endif; ?>>
                                    <span class="footer-icon">
                                        <i data-lucide="<?php echo e($item['icon']); ?>" class="w-4 h-4"></i>
                                    </span>
                                    <span><?php echo e($item['label']); ?></span>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $socialItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($item['href']); ?>" class="footer-social-link" aria-label="<?php echo e($item['label']); ?>" target="_blank" rel="noopener noreferrer">
            ...
            <div class="pt-8 md:pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left text-[11px] text-slate-400 font-bold uppercase tracking-widest">
                <div>&copy; <?php echo e(date('Y')); ?> <?php echo e($data['profile']['name']); ?>. All Rights Reserved.</div>
...
<?php /**PATH C:\laragon\www\webporto\resources\views/components/layout.blade.php ENDPATH**/ ?>